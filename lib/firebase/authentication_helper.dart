  ...
  void signInWithTwitter(BuildContext context) async {
    try {
      ...
      final twitterLogin = TwitterLogin(
        apiKey: "apiKey ${AppString.instance.twitterLoginAdd}",
        apiSecretKey: "apiSecretKey ${AppString.instance.twitterLoginAdd}",
        redirectURI: "redirectURI ${AppString.instance.twitterLoginAdd}",
      );
